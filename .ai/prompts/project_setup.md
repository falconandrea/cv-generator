...
1. .ai/context/TECH_STACK.md - Locked versions and constraints
2. .ai/context/PRD.md - Complete product requirements
3. .ai/context/APP_FLOW.md - User journeys documented
4. .ai/context/FRONTEND_GUIDELINES.md - Design system (if applicable)
5. .ai/context/BACKEND_STRUCTURE.md - Database schema and architecture
6. .ai/context/IMPLEMENTATION_PLAN.md - Step-by-step build sequence
7. .ai/context/API_CONTRACTS.md - API endpoints (if applicable)
8. .ai/memory/progress.md - Initial status
